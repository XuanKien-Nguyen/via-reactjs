        ...
        >
            {product.sum_via ?
                <div style={{fontSize: '15px'}}>
                    ...
                    <Input autoFocus addonBefore={t('product.enter_value')} max={product.sum_via} addonAfter={`x${product?.price || 0}`} type={'number'} value={quantity} onChange={onChangeQuantity} onPressEnter={() => { }} />
